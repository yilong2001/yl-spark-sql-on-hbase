...
public class WorkerResources implements org.apache.thrift.TBase<WorkerResources, WorkerResources._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerResources> {
  ...
  public double mem_on_heap; // optional
  public double mem_off_heap; // optional
  public double cpu; // optional
  ...
  @Override
  public void clear() {
    setMem_on_heapIsSet(false);
    this.mem_on_heap = 0.0;
    setMem_off_heapIsSet(false);
    this.mem_off_heap = 0.0;
    setCpuIsSet(false);
    this.cpu = 0.0;
  }

  public double getMem_on_heap() {
    return this.mem_on_heap;
  }

  public WorkerResources setMem_on_heap(double mem_on_heap) {
    this.mem_on_heap = mem_on_heap;
    setMem_on_heapIsSet(true);
    return this;
  }

  public void unsetMem_on_heap() {
  ...
  public boolean isSetMem_on_heap() {
    return EncodingUtils.testBit(__isset_bitfield, __MEM_ON_HEAP_ISSET_ID);
  }

  public void setMem_on_heapIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __MEM_ON_HEAP_ISSET_ID, value);
  }

  public double getMem_off_heap() {
    return this.mem_off_heap;
  }

  public WorkerResources setMem_off_heap(double mem_off_heap) {
    this.mem_off_heap = mem_off_heap;
    setMem_off_heapIsSet(true);
    return this;
  }

  public void unsetMem_off_heap() {
  ...
  public boolean isSetMem_off_heap() {
    return EncodingUtils.testBit(__isset_bitfield, __MEM_OFF_HEAP_ISSET_ID);
  }

  public void setMem_off_heapIsSet(boolean value) {
  ...
  public WorkerResources setCpu(double cpu) {
    this.cpu = cpu;
    setCpuIsSet(true);
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case MEM_ON_HEAP:
      return getMem_on_heap();

    case MEM_OFF_HEAP:
      return getMem_off_heap();
  ...
  public boolean isSet(_Fields field) {
    ...
    switch (field) {
    case MEM_ON_HEAP:
      return isSetMem_on_heap();
    case MEM_OFF_HEAP:
      return isSetMem_off_heap();
    case CPU:
      return isSetCpu();
    }
    throw new IllegalStateException();
  ...
  public boolean equals(WorkerResources that) {
    ...
    boolean this_present_mem_on_heap = true && this.isSetMem_on_heap();
    boolean that_present_mem_on_heap = true && that.isSetMem_on_heap();
    ...
    boolean this_present_mem_off_heap = true && this.isSetMem_off_heap();
    boolean that_present_mem_off_heap = true && that.isSetMem_off_heap();
  ...
  public int hashCode() {
    ...
    boolean present_mem_on_heap = true && (isSetMem_on_heap());
    list.add(present_mem_on_heap);
    if (present_mem_on_heap)
      list.add(mem_on_heap);

    boolean present_mem_off_heap = true && (isSetMem_off_heap());
  ...
  public int compareTo(WorkerResources other) {
    ...
    lastComparison = Boolean.valueOf(isSetMem_on_heap()).compareTo(other.isSetMem_on_heap());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetMem_off_heap()).compareTo(other.isSetMem_off_heap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMem_off_heap()) {
  ...
  private static class WorkerResourcesStandardScheme extends StandardScheme<WorkerResources> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, WorkerResources struct) throws TException {
        ...
        switch (schemeField.id) {
          case 1: // MEM_ON_HEAP
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              ...
              struct.setMem_on_heapIsSet(true);
            } else {
          ...
          case 2: // MEM_OFF_HEAP
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              ...
              struct.setMem_off_heapIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkerResources struct) throws TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.isSetMem_on_heap()) {
        oprot.writeFieldBegin(MEM_ON_HEAP_FIELD_DESC);
        oprot.writeDouble(struct.mem_on_heap);
        oprot.writeFieldEnd();
      }
      if (struct.isSetMem_off_heap()) {
  ...
  private static class WorkerResourcesTupleScheme extends TupleScheme<WorkerResources> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WorkerResources struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WorkerResources struct) throws TException {
